...
# Description: Querying fishbase for fork-length/total-lengthe relationships per
...
library(stringr)
library(purrr)
source('scripts/01_dataprep/_length_help_funcs.R')

# ==== Paths and global variables ====

# Directory where lenght-length coefficients table
ll_dir <- 'data/length_length_coeffs'
dir.create(ll_dir)
